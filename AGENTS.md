...
Если `.beads/` нет — инициализировать через `bd init` (автоматически при старте сессии).
...
2. Если `.beads/` нет → инициализировать через `bd init`. НЕ продолжать работу пока не инициализирован.
